...
/** Image with graceful fallback if file is missing */
function Img({
  src,
  alt,
  className,
...
/* =========================================================
   Affiliates loader (edit /public/affiliates.json)
   =======================================================*/
...
function buildAmazonSearch(q: string, tag?: string) {
  ...
  return `https://www.amazon.com/s?k=${urlQ}${
...
function FAQ() {
  const faqs = [
    {
      q: "Is 3D printing safe for kids?",
      a: "With supervision, enclosed printers, and PLA filament, it can be classroom-friendly. We verify models and provide printable Safety Cards.",
    },
    {
      q: "What slicer settings should I start with?",
      a: "0.2 mm layer, 15% infill, supports only when needed. Use our beginner profiles as a base.",
    },
    {
      q: "Do you support school POs?",
      a: "Yes. Use the Bundles page to request a quote or email hello@kidprint3d.com.",
    },
    {
      q: "How do you verify STLs?",
      a: "We check for appropriate content, risky mechanisms, and printability. Community can report any model.",
    },
  ];
  const [open, setOpen] = React.useState<string | null>(faqs[0].q);
  return (
    <section className="mx-auto max-w-5xl px-6 pb-12">
      <h3 className="mb-4 text-center text-2xl font-extrabold text-white">
        FAQ
      </h3>
      <div className="mb-4 flex justify-center">
        <button
          onClick={printSafetyCards}
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 pt-2">
      <div className="mb-3 flex items-center justify-center gap-2 rounded-xl border border-indigo-400/40 bg-indigo-500/10 px-3 py-2 text-sm text-indigo-200">
        ...
        <span>
          <strong>Share KidPrint:</strong> help a teacher or parent find safe 3D
          printing.
        </span>
        <button
          onClick={copy}
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-0 backdrop-blur">
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="mt-4 flex items-center gap-2 text-xs text-white/80">
              ...
              <span>
                Kid-Safe Promise: we list beginner printers and manually review
                STL content. Use “Report” on each model.
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-12">
      ...
      <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/70">
        <strong>Image note:</strong> Use your own or manufacturer-provided
        photos. Don’t use Amazon product photos unless fetched via their
        official API.
      </div>
    </section>
  );
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-12">
      ...
      <p className="mb-6 text-white/80">
        Pick a bundle, request a quote (POs welcome), or buy items individually
        via Amazon.
      </p>
      ...
      <div className="mb-6 flex flex-col items-start gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-white/80">
            Verified kid-friendly models. Every STL is reviewed for content and
            printability.
          </p>
        </div>
        <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row">
        ...
        {list.map((s) => (
          ...
          >
            ...
            <div className="text-xs text-white/70">
              {s.size}{" "}
              {s.level && (
                <span className="ml-2 rounded border border-white/10 px-1 py-0.5">
                  {s.level}
                </span>
              )}
            </div>
    ...
    <div className="min-h-screen bg-[#0b0b0e] text-white">
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0b0b0e]/85 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          <button
            className="text-left"
            onClick={() => setTab("home")}
            aria-label="KidPrint home"
          >
            <Logo />
          </button>
          <nav className="hidden items-center gap-2 md:flex">
            {(["home", "shop", "bundles", "stls", "learn"] as const).map(
              (t) => (
                <button
                  key={t}
                  className={cx(
      ...
      {tab === "learn" && (
        <section className="mx-auto max-w-5xl px-6 py-12">
          ...
          <p className="mb-6 text-white/80">
            Plain-English guidance for home and classroom use.
          </p>
          <ul className="grid list-none grid-cols-1 gap-4 md:grid-cols-2">
            {[
              {
                t: "Quickstart (10 minutes)",
                d: "Unbox, auto-level, load PLA, first print Benchy.",
              },
              {
                t: "Safety basics",
                d: "Supervision, enclosed printers, PLA only, ventilation, bed temps.",
              },
              {
                t: "Classroom setup",
                d: "Traffic flow, signage, roles, cleanup checklist.",
              },
              {
                t: "Print settings",
                d: "Layer 0.2mm, 15% infill, supports only when needed.",
              },
            ].map((x) => (
              <li
                key={x.t}
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            <a
              href={mailto(
                "hello@kidprint3d.com",
                "School pricing request",
                "Tell us your school name, quantity, and timeframe."
              )}
      ...
      <footer className="border-t border-white/10 py-8 text-center text-sm text-white/70">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-2 text-xs text-white/60">
            Disclosure: As an Amazon Associate we earn from qualifying
            purchases. Some “Buy” links are affiliate links.
          ...
          >
            ...
            >
              ...
              <p className="text-white/80">
                We don’t sell personal data. If you email us, we use your email
                only to reply. For analytics we recommend privacy-friendly
                Cloudflare Web Analytics. Request deletion anytime:
                hello@kidprint3d.com.
              </p>
            </motion.div>
          </motion.div>
        ...
        {showTerms && (
          ...
          >
            ...
            >
              ...
              <p className="text-white/80">
                All content provided “as-is.” Always supervise kids around
                printers. Use PLA for school/home. Some links are affiliate
                links; they do not change our recommendations.
              </p>
            </motion.div>
          </motion.div>
        )}
